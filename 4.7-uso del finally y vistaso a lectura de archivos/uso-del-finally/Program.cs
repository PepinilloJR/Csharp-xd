...
namespace usoDelFinally
{
    ...
    class Program
    {
        ...
        static int LecturaDatosTexto(string datos)
        {
            ...
            {
                // cerramos el stream, un stream es un flujo de datos a travez de un canal que utiliza un buffer para almacenar datos temporalmente mientras se transfieren
